<?php
    ...
    function tampilBuku() {
        ...
        foreach ($buku as $bk) {
            ...
            echo "<td>"."<a href = 'FormBuku.php?id_buku=".$bk['id_buku']."' class='btn btn-primary'>Edit</a>";
            echo " ";
            echo "<a href='Buku.php?id_buku=" . $bk['id_buku'] . "' onclick=\"return confirm('lanjut delete ?')\" class='btn btn-primary'>Hapus</a> </td>";
    ...
    function tampilMember() {
        ...
        foreach ($member as $mb) {
            ...
            echo "<td>"."<a href = 'FormMember.php?id_member=".$mb['id_member']."' class='btn btn-primary'>Edit</a>";
            echo " ";
            echo "<a href='Member.php?id_member=" . $mb['id_member'] . "' onclick=\"return confirm('lanjut delete ?')\" class='btn btn-primary'>Hapus</a> </td>";
            echo "</tr>";
        }
    }
    ...
    function tampilPeminjaman() {
        ...
        foreach ($peminjaman as $pj) {
            ...
            echo "<td>". $pj['tgl_peminjaman']."</td>";
            echo "<td>". $pj['tgl_kembali']."</td>";
            echo "<td>"."<a href = 'formpeminjaman.php?id_peminjaman=".$pj['id_peminjaman']."' class='btn btn-primary'>Edit</a>";
            echo " ";
            echo "<a href='Peminjaman.php?id_peminjaman=" . $pj['id_peminjaman'] . "' onclick=\"return confirm('lanjut delete ?')\" class='btn btn-primary'>Hapus</a> </td>";
            echo "</tr>";
        }
    }
